      ...
      <div className="content">
        ...
        <ul className="content-list">
          <li>
            ...
            <a href="#">
              <img src="pic/S60.jpeg" alt="S60" />
            </a>
          </li>
          <li>
            <p>XC60 建議售價$2,390,000起</p>
            <a href="#">
              <img src="pic/XC60.jpeg" alt="S90" />
            </a>
          </li>
          <li>
            <p>XC40 建議售價$1,607,000起</p>
            <a href="#">
              <img src="pic/XC40.jpeg" alt="XC40" />
            </a>
          </li>
          <li>
            <p>XC90 建議售價$2,895,000起</p>
            <a href="#">
              <img src="pic/XC90.jpeg" alt="XC90" />
            </a>
          </li>
        </ul>
      ...
      <div className="content2">
        <ul className="content-list">
          <li>
            <p>Content Box 5</p>
            <a href="#">
              <img src="pic/xc60-recharge-gallery-1-16x9.jpeg" alt="S60" />
            </a>
          </li>
          <li>
            <p>Content Box 6</p>
            <a href="#">
              <img src="pic/xc60-recharge-gallery-3-16x9.jpeg" alt="S90" />
            </a>
          </li>
          <li>
            <p>Content Box 7</p>
            <a href="#">
              <img src="pic/xc60-recharge-gallery-4-16x9.jpeg" alt="XC40" />
            </a>
          </li>
          <li>
            <p>Content Box 8</p>
            <a href="#">
              <img src="pic/xc60-recharge-gallery-5-16x9.jpeg" alt="XC90" />
            </a>
          </li>
        </ul>
      </div>
